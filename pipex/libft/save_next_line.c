...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/26 00:44:59 by jorge             #+#    #+#             */
/*   Updated: 2023/08/26 00:53:30 by jorge            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static char	*join_free(char *text, const char *buffer)
{
	char			*temp;
	unsigned int	len1;
	unsigned int	len2;
...
static char	*erase_returned_line(char *text, unsigned int llen)
{
	unsigned int	tlen;
	unsigned int	count;
	char			*temp;
...
int	save_next_line(int fd, char **line)
{
	static char		*text;
	unsigned int	llen;
